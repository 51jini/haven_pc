...
<html lang="ko">
    <head>
        ...
        <title>이그제큐티브 | HAVEN HOTEL</title>
    ...
    <body>
       ...
       <nav id="subMenu">
           <ul class="column04">
               <li><a href="./superior.php">슈페리어</a></li>
               <li><a href="./deluxe.php">디럭스</a></li>
               <li class="active"><a href="./executive.php">이그제큐티브</a></li>
               <li><a href="suite.html">스위트</a></li>
           </ul>
       </nav>
       <div id="subContents" class="room">
           <div class="title">
               <h3>이그제큐티브</h3>
               <p>탁트인 전망, 나무 바닥재부터 독서등까지 세심한 배려가 더해진 이그제큐티브 객실에서는<br>효율적인 비즈니스를 위한 맞춤 서비스를 경험하실 수 있습니다.</p>
           </div>
           <div class="slideWrap">
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><img src="../images/room/executive_img_01.jpg" alt="이그제큐티브룸 이미지01"></div>
                        <div class="swiper-slide"><img src="../images/room/executive_img_02.jpg" alt="이그제큐티브룸 이미지02"></div>
                        <div class="swiper-slide"><img src="../images/room/executive_img_03.jpg" alt="이그제큐티브룸 이미지03"></div>
                        <div class="swiper-slide"><img src="../images/room/executive_img_04.jpg" alt="이그제큐티브룸 이미지04"></div>
                        <div class="swiper-slide"><img src="../images/room/executive_img_05.jpg" alt="이그제큐티브룸 이미지05"></div>
                    </div>
