    ...
    <body>
       ...
       <nav id="subMenu">
           <ul class="column04">
               ...
               <li><a href="./deluxe.php">디럭스</a></li>
               <li><a href="./executive.php">이그제큐티브</a></li>
               <li class="active"><a href="./suite.php">스위트</a></li>
           </ul>
       </nav>
       <div id="subContents" class="room">
           <div class="title">
               <h3>스위트</h3>
               <p>특별한 날, 달콤한 분위기를 즐기고 싶은 분들에게<br>합리적인 가격으로 풍성한 만족스러움을 안겨줄 것입니다.</p>
           </div>
           <div class="slideWrap">
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><img src="../images/room/suite_img_01.jpg" alt="스위트룸 이미지01"></div>
                        <div class="swiper-slide"><img src="../images/room/suite_img_02.jpg" alt="스위트룸 이미지02"></div>
                        <div class="swiper-slide"><img src="../images/room/suite_img_03.jpg" alt="스위트룸 이미지03"></div>
                        <div class="swiper-slide"><img src="../images/room/suite_img_04.jpg" alt="스위트룸 이미지04"></div>
                        <div class="swiper-slide"><img src="../images/room/suite_img_05.jpg" alt="스위트룸 이미지05"></div>
                    </div>
           ...
           <div class="textWrap suite">
               ...
               <div class="default fl mb">
                   ...
                   <ul>
                       ...
                       <li>
                           · 크기 : 59㎡ / 18평<br>
                            <span class="tab">89㎡ / 27평</span>
                       </li>
                   </ul>
                   <ul>
                       <li>· 전망 : 시내뷰,하버뷰</li>
                       <li>· 침대 타입 : 싱글,더블,트윈,패밀리</li>
                   </ul>
                   <ul class="last">
                       <li>· 체크인 15:00</li>
                       <li>· 체크아웃 12:00</li>
