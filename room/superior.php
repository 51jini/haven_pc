...
<html lang="ko">
    ...
    <body>
       ...
       <nav id="subMenu">
           <ul class="column04">
               <li class="active"><a href="./superior.php">슈페리어</a></li>
               <li><a href="./deluxe.php">디럭스</a></li>
               <li><a href="./executive.php">이그제큐티브</a></li>
               <li><a href="./suite.php">스위트</a></li>
           </ul>
       ...
       <div id="subContents" class="room">
           <div class="title">
               <h3>슈페리어</h3>
               <p>아늑한 인테리어, 취사가 가능한 미니 키친 시설, 특급 서비스가 겸비된 슈페리어 객실은<br>
               실속형 여행객은 물론 장기 투숙객에게 안성맞춤인 객실입니다.</p>
           </div>
           <div class="slideWrap">
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><img src="../images/room/superior_img_01.jpg" alt="슈페리어룸 이미지01"></div>
                        <div class="swiper-slide"><img src="../images/room/superior_img_02.jpg" alt="슈페리어룸 이미지02"></div>
                        <div class="swiper-slide"><img src="../images/room/superior_img_03.jpg" alt="슈페리어룸 이미지03"></div>
                        <div class="swiper-slide"><img src="../images/room/superior_img_04.jpg" alt="슈페리어룸 이미지04"></div>
                        <div class="swiper-slide"><img src="../images/room/superior_img_05.jpg" alt="슈페리어룸 이미지05"></div>
                    </div>
           ...
           <div class="textWrap">
               ...
               <div class="roomFacility fl">
                   <h5>객실시설</h5>
                   <ul>
                       <li>· 미니 키친 시설 (인덕션, 레인지후드, 냉장고, 식기 등)</li>
                       <li>· 40인치 LED TV</li>
                       <li>· 유니버셜 어댑터</li>
                       <li>· 객실 내 금고</li>
                       <li>· 욕실용품</li>
